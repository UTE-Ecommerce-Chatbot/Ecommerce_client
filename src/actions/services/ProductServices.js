...
export const getProductListByCategoryAndSubcategory = (searchObject) => {
  return axios.get(
    `${API_URL}/api/product/danh-muc/${searchObject.category}/${searchObject.subcategory}?page=${searchObject.page}&keyword=${searchObject.keyword}&sortBy=${searchObject.sortBy}&sortValue=${searchObject.sortValue}&brand=${searchObject.brand}&price=${searchObject.price}`
  );
};
export const getProductList = (searchObject) => {
  return axios.get(
    `${API_URL}/api/product/search?page=${searchObject.page}&keyword=${searchObject.keyword}`
  );
};

export const getProductListByCategory = (categoryCode, searchObject) => {
  return axiosClient({
    method: "GET",
    url: `${API_URL}/api/product/danh-muc/${categoryCode}?page=${searchObject.page}&keyword=${searchObject.keyword}`,
  });
};
...
export const getProductByCategory = (searchObject) => {
  return axios.get(
    `${API_URL}/api/product/danh-muc/${searchObject.category}?page=${searchObject.page}&keyword=${searchObject.keyword}`
  );
};
...
export const getAllProductByBrand = (productId, brandCode) => {
  return axios.get(
    `${API_URL}/api/product/brand?productId=${productId}&brandCode=${brandCode}`
  );
};
...
export const getAllProductByBrandCode = (searchObject) => {
  return axios.get(
    `${API_URL}/api/product/all/${searchObject.brandCode}?page=${searchObject.page}&keyword=${searchObject.keyword}&sortBy=${searchObject.sortBy}`
  );
};
...
// get 10 gần đây được người dùng xem
