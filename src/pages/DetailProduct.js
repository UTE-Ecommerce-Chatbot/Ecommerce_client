...
function DetailProduct(props) {
    ...
    const addQuery = (key, value) => {
        ...
        history.push({
            pathname: pathname, search: searchParams.toString(),
        });
    };
    ...
    useEffect(() => {
        if (myRef.current && myRef.current.children && myRef.current.children[index]) {
    ...
    const handleAddToCart = () => {
        if (username) {
            const data = {
                cart_details: [{
                    product_id: product?.id, quantity, color: color
                }]
            }
            ...
            {!loading ? (<div className="row sm-gutter section__content">
                    <div className="breadcrumb">
                        ...
                        <Link className="breadcrumb-item"
                              to={`/${product?.category?.code}/${product?.subcategory?.code}`}>{product?.subcategory?.name}</Link>
                    ...
                    <div className="col l-12 m-12 c-12">
                        <div className="product-info">
                                ...
                                <div className="col l-7 m-6 c-12">
                                    <div className="product-detail">
                                        ...
                                        <div className="product-detail-info">
                                            ...
                                            <p className="product-seller"><span>{product?.seller_count}</span> Đã Bán
                                            </p>
                                        </div>
                                    </div>
                                    <div className="product-detail-body">
                                        <div className="left">
                                            <p className="product-price">
                                                <span
                                                    className="product-price__current-price">{currency(product.price)}</span>
                                                <span
                                                    className="product-price__list-price">{currency(product.list_price)}</span>
                                            ...
                                            <div className="product_pick_color">
                                                <div className="prco_label">
                                                    ...
                                                    Bạn đang
                                                    chọn <strong>{color ? color : product?.inventories?.[0]?.color}</strong>
                                                </div>.
                                            ...
                                            <div id="info-1" className="collapse in">
                                                ...
                                                <div className="group-input">
                                                    <button
                                                        ...
                                                        <img src={`${DECREASE_IMG}`} alt="remove-icon"
                                                             width={20} height={20}/>
                                                    </button>
                                                    <input
                                                        type="number"
                                                    ...
                                                    <button
                                                        ...
                                                        <img src={`${INCREASE_IMG}`} alt="add-icon" width={20}
                                                             height={20}/>
                                                    </button>
                                                </div>
                                                <div className="input-label">
                            ...
                            <div className="row sm-gutter section__item">
                                ...
                                {loading ? <ProductItemSkeleton total={similarProduct.length}/> :
                                        ...
                                        return (<div className="review-comment" key={item.id}>
                                                    ...
                                                    <div className="review-comment__user-inner">
                                                        <div className="review-comment__user-avatar">
                                                            <div className="has-character">
                                                                <img src={`${API_URL}/images/avatar.png`}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <div
                                                                className="review-comment__user-name">{item.displayName}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div style={{flexGrow: 1}}>
                                                    ...
                                                    <div className="review-comment__seller-name-attributes">
                                                        <div className="review-comment__seller-name">Thương hiệu<span
                                                            className="review-comment__check-icon"/>{product.brand?.name}
                                                        </div>
                                                    </div>
                                                    <div
                                                        className="review-comment__content">{item.content}</div>
                            ...
                            <div className="row sm-gutter section__item">
                                ...
                                {loading ? <ProductItemSkeleton total={mostPopularProduct.length}/> :
                            ...
                            <div className="row sm-gutter section__item">
                                ...
                                {loading ? <ProductItemSkeleton total={recommendList.length}/> :
                            ...
                            <div className="row sm-gutter section__item">
                                ...
                                {loading ? <ProductItemSkeleton total={productViewed.length}/> :
