            ...
            <div className="row sm-gutter section__item">
              <div className="col l-6 m-4 c-4">
                <div className="content-left">
                  ...
                  <img
                    src="https://pipe.tikicdn.com/media/upload/2018/10/12/2a3acb91a35d45e1b4b7c96912a0c84a.png"
                    alt=""
                  />
                </div>
              </div>
                  ...
                  <Grid className="" container spacing={2}>
                    ...
                    <Grid item sm={12} xs={12}>
                      <div className="auth-form__social">
                        ...
                        >
                          {/* <i className="auth-form__social-icon fab fa-google"></i> */}
                          {/* <img className="auth-form__social-icon" src="https://w7.pngwing.com/pngs/74/276/png-transparent-zalo-hd-logo-thumbnail.png" alt="" /> */}
                          <span className="auth-form__social-text">
                            Kết nối với Zalo
                          </span>
                        </Link>
                    ...
                    <Grid>
                      <div style={{ fontSize: "13px", marginLeft: "210px" }}>
                        <br />
                        ____________ hoặc ____________
                        <br />
                      </div>
                    </Grid>
                    <Grid>
